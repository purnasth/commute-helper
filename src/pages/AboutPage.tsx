  ...
  return (
    <>
      <main>
        ...
        <div className="gap-8 xl:grid xl:grid-cols-6">
          <div className="sticky top-0 max-h-fit bg-white p-4 xl:col-span-1 xl:pt-16">
            <ul className="flex w-full items-center justify-around xl:flex-col xl:items-start xl:gap-8">
              {aboutNavLinks.map((navLink) => (
                <li key={navLink.id}>
                  <a
                    href={`#${navLink.id}`}
                    className={`transition-300 text-sm md:text-2xl ${
          ...
          <aside className="space-y-3 xl:col-span-5 xl:space-y-12">
            {aboutNavLinks.map((navLink) => (
              <section
                key={navLink.id}
                id={navLink.id}
