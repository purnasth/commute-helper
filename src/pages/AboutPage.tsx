  ...
  return (
    <>
      <main>
        ...
        <div className="mx-auto flex flex-col items-start justify-between gap-0 xl:w-2/3 xl:flex-row xl:gap-12">
          <div className="sticky top-0 max-h-fit w-full bg-white p-4 dark:bg-dark xl:max-w-xs xl:pt-32">
            <ul className="flex w-full items-center justify-around xl:flex-col xl:items-start xl:gap-8">
              {aboutNavLinks.map((navLink) => (
                <li key={navLink.id}>
                  <a
                    href={`#${navLink.id}`}
                    className={`transition-300 text-sm md:text-base lg:text-xl xl:text-2xl ${
          ...
          <aside className="container space-y-3 xl:space-y-12">
            {aboutNavLinks.map((navLink) => (
              <section
                key={navLink.id}
                id={navLink.id}
                className="pt-10 sm:pt-12 md:pt-14"
              >
